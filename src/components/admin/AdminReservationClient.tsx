          ...
          <div className="flex flex-wrap justify-center gap-2">
            {reservation.status === "pending" ? (
              <button
                ...
                disabled={isBusy}
                className="w-24 rounded-xl bg-primary/10 px-3 py-2 text-xs font-semibold text-primary transition-all duration-300 hover:scale-105 hover:bg-primary/20 disabled:cursor-not-allowed disabled:opacity-50"
              >
                Confirm
              </button>
            ) : null}
            ...
            reservation.status === "confirmed" ? (
              <>
                <button
                  ...
                  disabled={isBusy}
                  className="w-24 rounded-xl bg-slate-100 px-3 py-2 text-xs font-semibold text-slate-600 transition-all duration-300 hover:scale-105 hover:bg-slate-200 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  No-Show
                </button>
                <button
                  ...
                  disabled={isBusy}
                  className="w-24 rounded-xl bg-red-50 px-3 py-2 text-xs font-semibold text-red-600 transition-all duration-300 hover:scale-105 hover:bg-red-100 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  Cancel
                </button>
              </>
