...
-- CreateTable: Add vip_arrival_logs table
...
CREATE INDEX IF NOT EXISTS "vip_arrival_logs_guest_id_checked_in_at_idx" ON "vip_arrival_logs"("guest_id", "checked_in_at");

-- AddForeignKey: Foreign key to guests table
